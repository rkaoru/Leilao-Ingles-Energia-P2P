...
def criar_oferta(oferta: Oferta):
    ...
    result = collection.insert_one(oferta_dict)
    oferta_dict["id"] = str(result.inserted_id)
    return oferta_dict
